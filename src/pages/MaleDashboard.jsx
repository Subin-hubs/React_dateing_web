...
const MaleDashboard = () => {
  ...
  useEffect(() => {
    if (showUsers) {
      const users = getUsersByGender('Female');
      setFemaleUsers(users);
    }
  }, [showUsers]);
        ...
        {!showUsers ? (
          <div className="max-w-lg mx-auto text-center py-12">
            ...
            <p className="text-gray-600 mb-8">
              Ready to find your perfect match? Click the button below to see available female users.
            </p>
            <button
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Available Female Users</h1>
            {femaleUsers.length > 0 ? (
              ...
              <div className="bg-white rounded-xl shadow-md p-8 text-center">
                <p className="text-gray-600 text-lg">No female users found. Please check back later.</p>
              </div>
            )}
          </div>
        )}
